...
# ===============================================================
# ✅ Centralized & Portable Weights Directory Setup
# Automatically finds project root and stores all GFPGAN weights there.
# ===============================================================
...
BASE_WEIGHTS_DIR = os.path.join(
    PROJECT_ROOT, "enhancement", "resolution", "GFPGAN", "gfpgan", "weights"
)
...
class GFPGANer():
    ...
    def __init__(self, model_path, upscale=2, arch='clean',
        ...
        ensure_weights_dir()   # ✅ ONLY created when GFPGAN is used
        ...
        self.face_helper = FaceRestoreHelper(
            ...
            use_parse=True,
            device=self.device,
            model_rootpath=BASE_WEIGHTS_DIR  # ✅ use portable dir
        )
        ...
        if model_path.startswith('https://'):
            model_path = load_file_from_url(
                url=model_path,
                model_dir=BASE_WEIGHTS_DIR,  # ✅ use portable dir
                progress=True,
                file_name=None
            )
